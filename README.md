...
**Status:** early development. Stages 4 and 5 are complete for the deterministic cited-briefing acceptance; Stage 6 has model capability metadata, provider-state, and model-router foundations. Tatu is not ready for production use yet.
