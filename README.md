...
**Status:** early development. Stages 4 and 5 are complete for the deterministic cited-briefing acceptance; Stage 6 provider/model routing and fallback is next. Tatu is not ready for production use yet.
